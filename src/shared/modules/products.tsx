  ...
  return (
    <div className="md:my-10 my-[15%] ">
        <div className="grid md:w-[80%] mx-auto gap-5 xl:grid-cols-5 sm:grid-cols-3 grid-cols-1">
          ...
          <p className="text-[#55585b] dark:text-white font-[400] text-[14px]"> 3 Products</p>
          </div>
          <div className="text-center">
          ...
          <p className="text-[#55585b] dark:text-white font-[400] text-[14px]"> 2 Products</p>
          </div>
          <div className="text-center">
