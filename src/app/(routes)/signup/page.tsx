...
const Page = () => {
  ...
  return (
    <div className="w-full mt-[15%] bg-[#FFFFFF] dark:bg-black font-jost">
      ...
      <div className="mt-5 form-wrapper relative xl:w-[40%] dark:bg-[#0C1518] md:w-[60%] w-full mx-auto pt-[50px] px-5 sm:px-10 pb-[70px] bg-[#fff] text-center mb-[40px]">
        ...
        <p className="absolute top-[10px] dark:text-black left-[10px] text-[14px] leading-[1] bg-white px-3">
            Your Name
          </p>
          <input
          ...
          />
          <p className="absolute left-[10px] dark:text-black bottom-[200px] text-[14px] leading-[1] bg-white px-3">
            Your Email
          </p>
          <input
            className="p-4 border w-full mb-10 text-[14px] "
          ...
          />
          <p className="absolute left-[10px] dark:text-black bottom-[105px] text-[14px] leading-[1] bg-white px-3">
            Password
          </p>
          <input
